// Gmsh project created on Fri Oct 30 10:39:39 2015
cl__1 = 20;
cl__2 = 10;
Point(1) = {0, -200, 0, 20};
...
Point(11) = {0, 200, 0, 20};
Point(12) = {0, -200, 185, 20};
Point(13) = {300, -200, 185, 10};
Point(17) = {508.3778132, -1381.76930361, 185, 20};
Point(21) = {902.300914405, -1312.31003255, 185, 20};
Point(25) = {723.215385232, -296.665527018, 185, 10};
Point(29) = {767.819926237, 0, 185, 10};
Point(30) = {831.659443104, 293.128838748, 185, 10};
Point(34) = {1795.49895998, 1256.96835562, 185, 20};
Point(38) = {1724.78828186, 1327.67903374, 185, 20};
Point(42) = {597.109248121, 200, 185, 10};
Point(46) = {0, 200, 185, 20};
Line(1) = {1, 2};
Line(2) = {2, 3};
Line(3) = {3, 4};
Line(4) = {4, 5};
